...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='SparsePointEnvImage-v0', help='environment to train on')
    ...
    parser.add_argument('--policy_num_steps', type=int, default=180,
    ...
    parser.add_argument('--lr_representation_learner', type=float, default=7e-4)
