...
def get_args(rest_args):
    ...
    parser.add_argument('--sampling_method', type=str, default='precise', help='choose (fast, precise), where fast assumes dynamics are different for every trajectory and that z-s can be freely sampled from other trajectories')
    # general
    ...
    parser.add_argument('--representation_learner_batch_num_trajs', type=int, default=5,
