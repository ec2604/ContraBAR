...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='SparsePointEnvWind-v0', help='environment to train on')
    ...
    parser.add_argument('--representation_learner_batch_num_trajs', type=int, default=15,
