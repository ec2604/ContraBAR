...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='Maze-v0', help='environment to train on')
    ...
    parser.add_argument('--lr_policy', type=float, default=4e-4, help='learning rate (default: 7e-4)')
    ...
    parser.add_argument('--size_vae_buffer', type=int, default=40,
