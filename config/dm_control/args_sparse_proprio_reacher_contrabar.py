...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='SparseProprioReacher-v0', help='environment to train on')
    ...
    # cpc
    parser.add_argument('--negative_factor', type=int, default=10, help='number of negative samples per positive for CPC batch')
