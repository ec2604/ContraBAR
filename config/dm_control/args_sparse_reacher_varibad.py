...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='SparseReacher-v0', help='environment to train on')
    ...
    parser.add_argument('--policy_task_embedding_dim', type=int, default=10)
    ...
    parser.add_argument('--lr_policy', type=float, default=2e-4, help='learning rate (default: 7e-4)')
    ...
    # cpc
    parser.add_argument('--negative_factor', type=int, default=1, help='number of negative samples for CPC')
    parser.add_argument('--sampling_method', type=str, default='other', help='choose (fast, precise), where fast assumes dynamics are different for every trajectory and that z-s can be freely sampled from other trajectories')
    ...
    parser.add_argument('--num_trajs_representation_learning_buffer', type=int, default=5000,
    ...
    parser.add_argument('--underlying_state_dim', type=int, default=2)
