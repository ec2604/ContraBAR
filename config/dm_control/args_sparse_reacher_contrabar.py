...
def get_args(rest_args):
    ...
    parser.add_argument('--`norm_actions`_pre_sampling', type=boolean_argument, default=False, help='normalise policy output')
...
# combining vae and RL loss
    ...
    parser.add_argument('--eval_interval', type=int, default=150, help='eval interval, one eval per n updates')
    parser.add_argument('--vis_interval', type=int, default=150, help='visualisation interval, one eval per n updates')
