...
def get_args(rest_args):
    ...
    parser.add_argument('--state_embedding_size', type=int, default=120)
    ...
    parser.add_argument('--latent_dim', type=int, default=80, help='dimensionality of latent space')
    parser.add_argument('--image_encoder_layers', default=[(32,3,2), (32,3,2), (32,3,2), (32,3,2)])
    ...
    parser.add_argument('--pixel_based', type=boolean_argument, default=True, help='pixel based observations')
    # --- OTHERS ---
