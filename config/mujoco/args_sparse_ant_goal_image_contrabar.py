...
def get_args(rest_args):
    ...
    parser.add_argument('--num_frames', type=int, default=2.5e8, help='number of frames to train')
    ...
    parser.add_argument('--env_name', default='SparseAntGoalImage-v0', help='environment to train on')
    ...
    parser.add_argument('--policy_state_embedding_dim', type=int, default=50)
    parser.add_argument('--policy_latent_embedding_dim', type=int, default=10)
    ...
    parser.add_argument('--ppo_clip_param', type=float, default=0.01, help='clamp param')
    ...
    parser.add_argument('--underlying_state_dim', type=int, default=())
...
# - encoder
    ...
    parser.add_argument('--state_embedding_size', type=int, default=80)
    ...
    parser.add_argument('--image_encoder_layers', default=[(32, 3, 2), (32, 3, 1), (32, 3, 1), (32, 3, 1)])
