...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='AntGoalImage-v0', help='environment to train on')
    ...
    parser.add_argument('--num_trajs_representation_learning_buffer', type=int, default=2000,
