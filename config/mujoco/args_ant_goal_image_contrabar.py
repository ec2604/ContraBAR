...
def get_args(rest_args):
    ...
    parser.add_argument('--policy_max_grad_norm', type=float, default=1.0, help='max norm of gradients')
...
# - encoder
    ...
    parser.add_argument('--encoder_layers_before_gru', nargs='+', type=int, default=[256])
