...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='PegInsertion-v1', help='environment to train on')
    ...
    parser.add_argument('--ppo_num_minibatch', type=int, default=3, help='number of minibatches to split the data')
    ...
    parser.add_argument('--lr_policy', type=float, default=7e-5, help='learning rate (default: 7e-4)')
    parser.add_argument('--num_processes', type=int, default=16,
                        help='how many training CPU processes / parallel environments to use (default: 16)')
    parser.add_argument('--policy_num_steps', type=int, default=80*3,
    ...
    parser.add_argument('--precollect_len', type=int, default=16000,
...
# - encoder
    ...
    parser.add_argument('--latent_dim', type=int, default=60, help='dimensionality of latent space')
    parser.add_argument('--lookahead_factor', type=int, default=50, help='lookahead for CPC')
    parser.add_argument('--image_encoder_layers', default=[(32, 3, 2), (32, 3, 1), (32, 3, 1)])
...
# combining vae and RL loss
    ...
    parser.add_argument('--save_interval', type=int, default=20, help='save interval, one save per n updates')
    ...
    parser.add_argument('--vis_interval', type=int, default=200, help='visualisation interval, one eval per n updates')
    parser.add_argument('--gradient_log_interval', type=int, default=1000)
