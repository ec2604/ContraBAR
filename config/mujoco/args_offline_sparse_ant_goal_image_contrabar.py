...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='OfflineSparseAntGoalImage-v0', help='environment to train on')
    ...
    parser.add_argument('--encoder_max_grad_norm', type=float, default=1., help='max norm of gradients')
    ...
    parser.add_argument('--lr_representation_learner', type=float, default=4e-4)
    ...
    parser.add_argument('--underlying_state_dim', default=(4, 64, 64))
