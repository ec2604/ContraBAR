...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='SparseAntGoal-v0', help='environment to train on')
    ...
    parser.add_argument('--policy_entropy_coef', type=float, default=0.003, help='entropy term coefficient')
    ...
    parser.add_argument('--evaluator_lr', type=float, default=1e-4, help='lr for MLP to evaluate representation')
    parser.add_argument('--evaluate_start_iter', type=int, default=30000, help='lookahead for CPC')
# - encoder
